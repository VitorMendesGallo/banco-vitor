...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            // Desabilitar CSRF. Para APIs REST, especialmente aquelas que não usam cookies para autenticação,
            // é comum desabilitar. Para um formulário de login tradicional com Thymeleaf, você poderia manter.
            ...
            // Por enquanto, como /usuarios/senhas está "permitAll()", não será exigido para ele.
    ...
    // EXEMPLO para o PASSO 4: Como configurar um usuário em memória para testar o login.
    ...
    public InMemoryUserDetailsManager userDetailsService() {
        UserDetails user = User.builder()
            ...
            .password(passwordEncoder().encode("senha123")) // Use o passwordEncoder para a senha
